    ...
    private void jbtnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCalcActionPerformed
        ...
        for (int i = 1; i <= lf; i++) {
            ...
            jtblSched.setValueAt(
                    curr.format(a.getBegBal(i, dtype)), i - 1, 1);
            jtblSched.setValueAt(
                    curr.format(a.getAnnDep(i, dtype)), i - 1, 2);
            jtblSched.setValueAt(
                    curr.format(a.getEndBal(i, dtype)), i - 1, 3);
